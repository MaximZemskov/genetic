...
class TestGenetic(unittest.TestCase):
    def setUp(self):
        ...
        self.test_child_a = ['00000110.101010110011010001111110', '10001000.101101001101111011101000',
                             '10000100.001110110010000001100000', '10000011.011011010100101010111111']
        self.test_child_b = ['00001001.001010000001100110010111', '10000000.110010000101010011110110',
                             '00001001.000100001001111010000110', '00001000.001111110010111111111100']
    ...
    def test_crossover_func(self):
        ...
        child_a = self.test_child_a
        child_b = self.test_child_b

        self.assertEquals((child_a, child_b), crossover(parent_a, parent_b, separator))
